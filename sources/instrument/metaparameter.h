...
#define OP(n, flags)                                \
    ...
    {"ssg", GS(ins.OP[n].ssg_eg), 0, 15, (flags)|MP_Bits}
    OP(OPERATOR1_HR, MP_Operator1),
    OP(OPERATOR2_HR, MP_Operator2),
    OP(OPERATOR3_HR, MP_Operator3),
    OP(OPERATOR4_HR, MP_Operator4),
#undef OP
    {"note", GS(ins.note_offset1), -128, 127, MP_NotAIFeature},
    {"vel", GS(ins.velocity_offset), -128, 127, MP_NotAIFeature},
    {"pk", GS(ins.percNoteNum), 0, 127, MP_NotAIFeature},
    {"kon", GS(ins.ms_sound_kon), 0, 65535, MP_Measure|MP_NotAIFeature},
    {"koff", GS(ins.ms_sound_koff), 0, 65535, MP_Measure|MP_NotAIFeature},
